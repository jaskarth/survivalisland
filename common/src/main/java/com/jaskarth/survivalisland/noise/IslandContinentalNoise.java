...
import com.jaskarth.survivalisland.util.CachedQueryableGrid2D;
import com.jaskarth.survivalisland.util.RoundedQueryShape;
...
public class IslandContinentalNoise {
    ...
    public IslandContinentalNoise(long seed,
                                  ...
                                  @NotNull OctaveNoise domainWarpNoise,
                                  @NotNull OctaveNoise rangeVariationNoise
    ) {
        this.seed = seed;
