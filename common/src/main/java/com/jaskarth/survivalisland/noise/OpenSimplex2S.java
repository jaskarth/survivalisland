package com.jaskarth.survivalisland.noise;

/**
 * 3D OpenSimplex2S noise with
...
public class OpenSimplex2S {
     ...
     */
    public static void vectorValuedNoise3_ImproveXY(long seed, double x, double y, double z, OpenSimplex2S.Vec3 destination) {
     ...
     * Vector magnitude range: [0, 1]
     */
    public static void vectorValuedNoise3_ImproveXZ(long seed, double x, double y, double z, OpenSimplex2S.Vec3 destination) {
     ...
     * Vector magnitude range: [0, 1]
     */
    public static void vectorValuedNoise3_Fallback(long seed, double x, double y, double z, OpenSimplex2S.Vec3 destination) {
     ...
     * Vector magnitude range: [0, 1]
     */
    private static void vectorValuedNoise3_UnrotatedBase(long seed, double xr, double yr, double zr, OpenSimplex2S.Vec3 destination) {
        destination.clear();
    ...
    private static void gradFrame(long seed, long xrvp, long yrvp, long zrvp, float dx, float dy, float dz, float falloff, OpenSimplex2S.Vec3 destination) {
        long hash = seed ^ xrvp ^ yrvp ^ zrvp;
        hash *= HASH_MULTIPLIER;
