package supercoder79.survivalisland.client;
...
public class GoVote {
    private static final String BRAND = "SuperCoder79";
    private static final String MOD = "Survival Island";
    ...
    private static class GoVoteScreen extends Screen {
        ...
        protected GoVoteScreen(Screen parent) {
            ...
            this.parent = parent;
            addGroup(s("Please read the following message from " + BRAND + "'s mod " + MOD + "."));
            ...
            addGroup(s("Thank you. - Jasmine \"SuperCoder79\""));
        }
