...
public final class IslandDensityFunctions {
    ...
    private static final ResourceKey<DensityFunction> SPAGHETTI_2D_THICKNESS_MODULATOR = ofMc("overworld/caves/spaghetti_2d_thickness_modulator");
    ...
    public static void init() {
        // build types
        Registry.register(Registry.DENSITY_FUNCTION_TYPES, new ResourceLocation("survivalisland", "islandcont"), IslandContinentalnessFunction.UCODEC);

        Holder<DensityFunction> isContEntry = register(ISLAND_CONTINENTALNESS, DensityFunctions.flatCache(DensityFunctions.cache2d(new IslandContinentalnessFunction())));
        ...
        register(ISLAND_BASE_TERRAIN, baseTerrain);
        ...
        register(ISLAND_SLOPED_CHEESE, DensityFunctions.add(noisegrad2, getFunction(BASE_3D_NOISE_OVERWORLD)));
        ...
        register(ISLAND_FINAL_DENSITY, finalDensity);
    }
    ...
    private static Holder<DensityFunction> register(ResourceKey<DensityFunction> resourceKey, DensityFunction func) {
