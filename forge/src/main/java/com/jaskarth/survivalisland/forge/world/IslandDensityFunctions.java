...
public final class IslandDensityFunctions {
    public static final DeferredRegister<MapCodec<? extends DensityFunction>> REGISTER2 = DeferredRegister.create(Registries.DENSITY_FUNCTION_TYPE, "survivalisland");
